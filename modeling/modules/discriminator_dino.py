"""
Modified From 
- https://github.com/lxa9867/ImageFolder/blob/main/tokenizer/tokenizer_image/discriminator_dino.py
- https://github.com/FoundationVision/vaex/blob/main/models/dino.py
"""
...
class FrozenDINOSmallNoDrop(nn.Module):
    ...
    def __init__(
        ...
        self.register_buffer('x_scale', (1.0 / s).reshape(1, 3, 1, 1))
        self.register_buffer('x_shift', ( - m / s).reshape(1, 3, 1, 1))
...
if __name__ == '__main__':
    ...
    DinoDiscriminator.forward
    dd = DinoDiscriminator(dino_ckpt_path=ckpt, device='cpu', ks=ks, norm_type=norm_type, norm_eps=norm_eps, key_depths=key_layers)
    dd.eval()
